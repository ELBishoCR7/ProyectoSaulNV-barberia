...
INSERT INTO `usuarios` (`nombre`, `apellido`, `email`, `password`, `telefono`, `admin`, `confirmado`, `token`) 
VALUES 
('Saul', 'Admin', 'saul.admin@correo.com', '$2y$10$9TTiKdZXQaUQaSbVKd7wPOucLusU8ebkv2h2IgqNjQXs.uLTW7CAq', '0987654321', 1, 1, '');
